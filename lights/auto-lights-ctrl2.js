...
//
// MTDX62-MB (ctrl2): 10(1П) 26(1К) 33(1КБ) 25+32(1КМ) 27(1Г) 21(1ГД) 24(1ГС) 23(1Т) 28(1СА)
...
var CH_MTD_PRESENCE = "presence_status";  // прошивка ctrl2 — lowercase
var CH_MTD_LUX      = "illuminance";      // прошивка ctrl2 — lowercase
...
var ROOMS = [
  ...
  {
    id: "1КБ", slug: "r_1kb", name: "Большой коридор",
    sensors: [
      { dev: "wb-msw-v3_1"   },
      { dev: "wb-msw-v3_157" },
    ],
    mtd: ["mtdx62-mb_33"],
    lights: ["wb-mr6cu_26/K5", "wb-mr6cu_26/K6"],
    linkedRooms: ["r_1p"],
  ...
  },
  {
    ...
    sensors: [],
    mtd: ["mtdx62-mb_25", "mtdx62-mb_32"],
    lights: ["wb-mr6cu_26/K4"],
    linkedRooms: [],
    pirWindowSec: 60, presenceDelaySec: 60, autoOffMin: 15,
    luxOn: 40, luxOff: 60,
  },
  {
...
defineVirtualDevice(VDEV, { title: "Свет авто — 1 эт.", cells: vdevCells });
